...
import FullScreeenPlayer from "components/FullScreeenPlayer";
...
export default function Player() {
  ...
  return (
    <div className="flex px-4 justify-between items-center h-full">
            ...
            <section className="flex items-center">
              <div className="flex items-center mr-3">
                ...
                <div>
                  ...
                  <p className="text-[0.688rem] text-white
                  text-opacity-70 ">{current.artist}</p>
                </div>
              </div>
        ...
        <div ref={fsRef}>
           {isFullscreen && 
           <FullScreeenPlayer toggle={toggle} state={state} controls={controls} volumeIcon={volumeIcon}
           />} 
        </div>
    </div>
  )
